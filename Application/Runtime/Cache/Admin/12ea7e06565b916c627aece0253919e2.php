...
<head>
    ...
    <!--[if lt IE 9]>
    <link rel="stylesheet" type="text/css" href="/Public/404/css/ie8.css" />
    <![endif]-->


    <script type="text/javascript" src="/Public/404/scripts/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="/Public/404/scripts/custom-scripts.js"></script>
    <script type="text/javascript" src="/Public/404/scripts/jquery.tipsy.js"></script>
