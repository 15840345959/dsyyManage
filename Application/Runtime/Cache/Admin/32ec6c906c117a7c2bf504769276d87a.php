...
<script type="text/javascript" src="/dsyyManage/Public/Admin/javascript/supplement.js"></script>
    <script src="/dsyyManage/Public/Admin/javascript/plug-ins/customScrollbar.min.js"></script>
    <script src="/dsyyManage/Public/Admin/javascript/pages/login.js"></script>
</head>
        ...
        <ul>
            ...
            <li>
                <div class="form-group">
                    ...
                    <img src="/dsyyManage/Admin/Verify/verify" width="34%" height="32px" id="verify" onclick="this.src=this.src+'?'+Math.random();" />
                </div>
            </li>
            <li>
